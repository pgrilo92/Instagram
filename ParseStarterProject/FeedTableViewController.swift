...
class FeedTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        imageFiles[(indexPath as NSIndexPath).row].getDataInBackground { (data, error) -> Void in
        ...
        myCell.username.text = usernames[(indexPath as NSIndexPath).row]
        
        myCell.message.text = messages[(indexPath as NSIndexPath).row]
